            ...
            <div class="w-full md:w-64 flex-shrink-0">
                <div class="bg-white rounded-xl shadow-lg p-6">
                    <div class="flex items-center space-x-4 mb-6">
                        <div class="h-12 w-12 rounded-full bg-leather-100 flex items-center justify-center text-leather-700 font-bold text-xl">
                    ...
                    <nav class="space-y-2">
                        <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 px-4 py-2 rounded-lg bg-leather-50 text-leather-900 font-medium">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                            </svg>
                            <span>Dashboard</span>
                        </a>
                        <a href="#" class="flex items-center space-x-3 px-4 py-2 rounded-lg text-neutral-600 hover:bg-neutral-50 hover:text-leather-900 transition-colors">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <form action="{{ route('logout') }}" method="POST" class="pt-4 mt-4 border-t border-neutral-100">
                            @csrf
                            <button type="submit" class="flex w-full items-center space-x-3 px-4 py-2 rounded-lg text-red-600 hover:bg-red-50 transition-colors">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex-grow">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="p-6 text-center text-neutral-500 py-12">
                        ...
                        <p>No orders found.</p>
                        <a href="{{ route('products.index') }}" class="inline-block mt-4 text-gold-600 font-medium hover:underline">Start Shopping</a>
                    </div>
                </div>
            </div>
        </div>
