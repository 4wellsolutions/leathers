                ...
                <div class="p-6 md:p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            @if($category->image)
                                <div class="mb-4">
                                    <p class="text-sm text-neutral-500 mb-2">Current Image:</p>
                                    <img src="{{ str_starts_with($category->image, 'http') ? $category->image : asset($category->image) }}" alt="Current Image"
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4"
                                class="block w-full rounded-lg border-neutral-300 shadow-sm focus:border-gold-500 focus:ring-gold-500 sm:text-sm py-3 px-4">{{ old('description', $category->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="meta_description" name="meta_description" rows="3"
                                    class="block w-full rounded-lg border-neutral-300 shadow-sm focus:border-gold-500 focus:ring-gold-500 sm:text-sm py-3 px-4">{{ old('meta_description', $category->meta_description) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
