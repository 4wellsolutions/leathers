...
@section('content')
    <div class="max-w-5xl mx-auto py-8">
        <form action="{{ route('admin.combos.store') }}" method="POST" class="space-y-8" id="combo-form">
            @csrf

            <!-- Header -->
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Create New Bundle</h1>
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4"
                                    ...
                                    placeholder="Describe what makes this bundle special...">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
