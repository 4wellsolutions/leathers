...
@section('content')
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <form action="{{ route('admin.sales.store') }}" method="POST" class="space-y-8 divide-y divide-neutral-200 p-6">
            @csrf
            ...
            <div class="space-y-8 divide-y divide-neutral-200">
                <div>
                    ...
                    <p class="mt-1 text-sm text-neutral-500">Create a new promotional sale.</p>
