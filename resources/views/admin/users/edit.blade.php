                ...
                <div class="p-6 md:p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                <label for="password" class="block text-sm font-medium text-neutral-700 mb-2">New Password
                                    (Optional)</label>
                            ...
                            <div>
                                <label for="password_confirmation"
                                    class="block text-sm font-medium text-neutral-700 mb-2">Confirm New Password</label>
