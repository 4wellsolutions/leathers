...
@section('content')
    <div class="max-w-5xl mx-auto py-8">
        <form action="{{ route('admin.deals.update', $deal->id) }}" method="POST" class="space-y-8" id="deal-form">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Update deal details and items.</p>
                </div>
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    <input type="text" name="slug" id="slug" value="{{ old('slug', $deal->slug) }}"
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4"
                                    ...
                                    placeholder="Describe what makes this deal special...">{{ old('description', $deal->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-6 space-y-6">
                            <div>
                                ...
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="price" id="price" value="{{ old('price', $deal->price) }}"
                                        step="0.01"
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="start_date" id="start_date"
                                    value="{{ old('start_date', $deal->start_date ? $deal->start_date->format('Y-m-d\TH:i') : '') }}"
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="end_date" id="end_date"
                                    value="{{ old('end_date', $deal->end_date ? $deal->end_date->format('Y-m-d\TH:i') : '') }}"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-gold-500 focus:ring-gold-500 sm:text-sm text-gray-600">
                            </div>
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="is_active" name="is_active" type="checkbox" value="1" {{ old('is_active', $deal->is_active) ? 'checked' : '' }}
    ...
    @push('scripts')
        <script>
            ...
            const dealItems = @json($deal->items);
            ...
            function addProduct(product) {
                ...
                if (product.variants && product.variants.length > 0) {
                    product.variants.forEach(variant => {
                        ...
                        // Check if this variant was already part of the deal
