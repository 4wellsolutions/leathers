...
@section('title', 'Edit Bundle: ' . $combo->name)

@section('content')
    <div class="max-w-5xl mx-auto py-8">
        <form action="{{ route('admin.combos.update', $combo->id) }}" method="POST" class="space-y-8" id="combo-form">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Update bundle details and items.</p>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-6 space-y-6">
                            <div>
                                <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Bundle Name <span
                            ...
                            <div>
                                ...
                                <textarea id="description" name="description" rows="4"
                                    ...
                                    placeholder="Describe what makes this bundle special...">{{ old('description', $combo->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
                            <h3 class="text-base font-semibold text-gray-900">Bundle Items</h3>
                        ...
                        <div class="p-6">
                            ...
                            <div id="empty-state"
                                class="text-center py-12 px-4 border-2 border-dashed border-gray-200 rounded-lg hidden">
                                ...
                                <p class="mt-1 text-sm text-gray-500">Search for products above to add them to this bundle.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-6 space-y-6">
                            <div>
                                <label for="price" class="block text-sm font-medium text-gray-700 mb-1">Bundle Price (Rs)
    ...
    @push('scripts')
        <script>
            ...
            const comboItems = @json($combo->items);
            ...
            // Map of variantId -> quantity/selected state for existing items
            ...
            comboItems.forEach(item => {
                ...
                if (variantId) {
                    existingQuantities[variantId] = item.quantity;
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                searchInput.addEventListener('input', function (e) {
                    ...
                    debounceTimer = setTimeout(() => {
                        fetch(`{{ route('admin.combos.search-products') }}?q=${query}`)
            ...
            function addProduct(product) {
                ...
                if (product.variants && product.variants.length > 0) {
                    product.variants.forEach(variant => {
                        ...
                        // Check if this variant was already part of the combo
                        const isSelected = selectedVariantIds.has(variant.id);
                        const qty = existingQuantities[variant.id] || 1;
