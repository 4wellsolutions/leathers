...
<body class="font-sans text-neutral-900 antialiased bg-neutral-50 flex flex-col min-h-screen">
    ...
    <!-- Meta Pixel Code (deferred to avoid impacting page speed) -->
    <script>
        (function () {
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=691777082197946&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
</body>
