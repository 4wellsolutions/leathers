        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-8 space-y-8">
                ...
                <div class="bg-red-50 rounded-xl shadow-sm border-2 border-red-500 overflow-hidden relative">
                    ...
                    <div class="p-6 md:p-8 space-y-6">
                        <h2 class="text-lg font-semibold text-red-900 border-b border-red-200 pb-4 mb-6">Pricing &
                            Discount</h2>
                        ...
                        <div>
                            ...
                            <select id="sale_id" name="sale_id"
                                ...
                                @foreach($sales as $sale)
                                    <option value="{{ $sale->id }}" {{ old('sale_id', $product->sale_id) == $sale->id ? 'selected' : '' }}>
                                        {{ $sale->name }}
                                    </option>
                                @endforeach
                            </select>
