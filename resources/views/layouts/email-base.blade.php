    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media only screen and (max-width: 600px) {
            ...
            .product-image { margin-right: 0; margin-bottom: 12px; width: 100%; height: 200px; }
    ...
    <div class="email-wrapper">
        <div class="email-container">
            ...
            <div class="email-footer">
                ...
                <p class="footer-text">
                    Questions? Contact us at <a href="mailto:hello@leathers.pk" class="footer-link">hello@leathers.pk</a>
                </p>
