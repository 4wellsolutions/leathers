...
@section('content')
    ...
    <p class="email-text">
        We're thrilled to have you as a customer! Your order has been received and is being prepared with care. We'll send you another email once your order has been confirmed and processed.
    </p>
