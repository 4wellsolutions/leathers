...
@section('content')
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        <p class="text-xl text-neutral-600 mb-8 animate-slide-up" style="animation-delay: 0.1s;">Your order <span class="font-bold text-leather-900">{{ $order->order_number }}</span> has been placed successfully.</p>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 mb-12 text-left animate-slide-up" style="animation-delay: 0.2s;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="text-neutral-600">{{ $order->city }}, {{ $order->postal_code }}</p>
        ...
        <div class="animate-slide-up" style="animation-delay: 0.3s;">
            <p class="text-neutral-600 mb-6">We'll send a confirmation email to <strong>{{ $order->customer_email }}</strong> with your order details and tracking information.</p>
